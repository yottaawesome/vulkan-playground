...
export namespace Vulkan
{
	...
	struct ImageViewFactory
	{
		...
		auto ToVulkanStruct(this const ImageViewFactory& self) noexcept -> vkr::VkImageViewCreateInfo
		{
		...
		auto operator()(this const ImageViewFactory& self) -> VkImageViewUniquePtr
		{
			if (not self.Device)
